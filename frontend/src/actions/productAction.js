...
export const deleteProduct = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.delete(`${process.env.REACT_APP_API_URL}/api/v1/admin/product/${id}`, { withCredentials: true });
...
export const getAllReviews = (id) => async (dispatch) => {
  try {
    ...
    const { data } = await axios.get(`${process.env.REACT_APP_API_URL}/api/v1/reviews?productId=${id}`,  { withCredentials: true });
